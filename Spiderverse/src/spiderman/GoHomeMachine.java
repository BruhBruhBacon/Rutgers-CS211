...
public class GoHomeMachine {
    ...
    public static void main(String[] args) {
        ...
        Graph g = new Graph();
        g.makeA(adj);
        for(DimensionNode d:cl){
            g.addVertex(d.getDimensionNumber());
        }
        
    }

    private void Dijkstras(ArrayList<LinkedList<DimensionNode>> aj,int vert, int source){
        ArrayList<Integer> done = new ArrayList<Integer>();
        ArrayList<Integer> fringe = new ArrayList<Integer>();
        ArrayList<Integer> shortestDistance = new ArrayList<Integer>();
